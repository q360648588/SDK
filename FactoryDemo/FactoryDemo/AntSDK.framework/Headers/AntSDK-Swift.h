...
- (void)GetDeviceSupportList:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull, enum AntError))success;
- (void)GetDeviceSupportFunctionDetailWithIndex:(NSInteger)index success:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull, enum AntError))success;
...
- (void)ReportScreenLevelWithSuccess:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull, enum AntError))success;
- (void)ReportScreenTimeLongWithSuccess:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull, enum AntError))success;
- (void)ReportLightScreenWithSuccess:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull, enum AntError))success;
- (void)ReportDeviceVibrationWithSuccess:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull, enum AntError))success;
...
@property (nonatomic, readonly) BOOL functionList_screenLevel;
@property (nonatomic, readonly) BOOL functionList_screenTimeLong;
...
@property (nonatomic, readonly, copy) NSArray<NSNumber *> * _Nonnull supportIndexArray;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, AntFunctionListType, open) {
  ...
  AntFunctionListTypeScreenTimeLong = 16,
  AntFunctionListTypeScreenLevel = 17,
