...
class ChargingBoxScanVC: UIViewController {
...
extension ChargingBoxScanVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        ZywlCommandModule.shareInstance.connectChargingBoxDevice(peripheral: model as Any, connectState: { (result) in
            if result {
                print("连接成功",peripheral?.name,peripheral?.identifier)

                let vc = ChargingBoxCommandVC.init()
