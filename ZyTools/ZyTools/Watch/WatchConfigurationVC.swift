...
class WatchConfigurationVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.dataSourceArray = [
            ...
            "\(NSLocalizedString("Date of update", comment: "更新日期")):2025-5-17",
        ]
...
extension WatchConfigurationVC:UITableViewDataSource,UITableViewDelegate {
