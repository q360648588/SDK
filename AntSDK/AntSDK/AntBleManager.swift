...
class AntBleManager: NSObject {

    public static let shareInstance = AntBleManager()
...
extension AntBleManager:CBCentralManagerDelegate {
    // MARK: - 蓝牙开关状态
...
extension AntBleManager:CBPeripheralDelegate{
    // MARK: - 发现服务
